...
//                 .put('/api/restaurant')
//                 .send(data)
//                 .expect((res) => { expect(res.body).to.deep.equal(ADD_SUCCESS); })
//                 .expect(200, done);
//         });
...
//                 .put('/api/restaurant')
//                 .send(data)
//                 .expect((res) => { expect(res.error.text).to.equal('Error'); })
//                 .expect(500, done);
//         });
//     });
...
//             request(server)
//                 .get('/api/restaurant')
//                 .query({ name: 'getTest', street: 'getStreet', postalCode: 'getPostalCode' })
